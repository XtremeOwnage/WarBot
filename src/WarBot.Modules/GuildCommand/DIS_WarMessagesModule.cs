...
namespace WarBot.Modules.GuildCommand
{
    ...
    /// </summary>
    public class WarMessagesModule : WarBOTModule
    {
        ...
        public async Task DisableWar(int War)
        {
            switch (War)
            {
                ...
                case 4:
                    ...
                    break;
                default:
                    await RespondAsync("Please select between 1 and 4. 1 is for 2am central standard time war, while 4 is 8pm CST.");
                    break;
            }
        }
        ...
        public async Task DisableWarPrepStarted()
        {
            ...
            await cfg.SaveConfig();
            await RespondAsync("I will no longer send a message when war prep starts.");
        }
        ...
        public async Task EnableWarPrepStarted()
        {
            ...
            await cfg.SaveConfig();
            await RespondAsync("I will send a message when the war prep starts.");
        }
        ...
        public async Task DisableWarPrepEnding()
        {
            ...
            await cfg.SaveConfig();
            await RespondAsync("I will no longer send a message 15 minutes before war starts");
        }
        ...
        public async Task EnableWarChannelClear()
        {
            ...
            await cfg.SaveConfig();
            await RespondAsync("When wars are started, I will automatically remove messages from the war channel.");
        }
        ...
        public async Task DisableWarChannelClear()
        {
            ...
            await cfg.SaveConfig();
            await RespondAsync("I will no delete messages from the war channel.");
        }
        ...
        public async Task EnableWarPrepEnding()
        {
            ...
            await cfg.SaveConfig();
            await RespondAsync("I will send messages 15 minutes before war starts");
        }
        ...
        public async Task DisableWarStarted()
        {
            ...
            await cfg.SaveConfig();
            await RespondAsync("I will no longer send notifications when the war starts.");
        }
        ...
        public async Task EnableWarStarted()
        {
            ...
            await cfg.SaveConfig();
            await RespondAsync("I will send notifications when the war starts.");
        }
        #endregion
        ...
        public async Task TestMessages()
        {
            try
            {
                ...
                if (ch == null)
                {
                    await RespondAsync("You do not have a valid channel configured for sending WAR messages.\r\n" +
                ...
                {
                    await RespondAsync($"I do not have the READ_MESSAGES permission for {CH.Mention}\r\n" +
                        $"Please grant me the proper permissions and try again.");
                    return;
                }
                else if (!CH.TestBotPermission(ChannelPermission.SendMessages))
                {
                    await RespondAsync($"I do not have the SEND_MESSAGES permission for {CH.Mention}\r\n" +
                        $"Please grant me the proper permissions and try again.");
                    return;
                }
