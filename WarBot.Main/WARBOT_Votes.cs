...
namespace WarBot
{
    public partial class WARBOT
    {
        ...
        private async Task Client_ReactionAdded(Cacheable<IUserMessage, ulong> arg1, ISocketMessageChannel arg2, SocketReaction arg3)
        {
            ...
            //        if (CurrentPoll.Votes.Any(o => o.UserId == arg3.UserId))
            //        {
            //            var ToRemove = CurrentPoll.Votes.Where(o => o.UserId == arg3.UserId);
            //            //Remove the reaction.
            //            await CurrentPoll.Message.RemoveReactionAsync(ToRemove, arg3.User.Value);

            //            //Update their vote.
            //            //urrentPoll.Votes.Add(new UserVote(arg3, [arg3.UserId] = arg3.Emote;

            //            //TODO - Correct the above line.
            //        }
            //        else
            //        {
